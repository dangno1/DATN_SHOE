                    ...
                    <tr>
                      <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                        <div className="inline-flex items-center gap-x-3">
                          ...
                          <div>
                            <img
                              src="https://bizweb.dktcdn.net/100/410/787/products/m2nltcj4uwd-mocbytimil-ldcrt-ac7txspjkhscowikr-vn5yme81isbw3cowmraele-pksvhgjoengixy-ynulerltdon11-ynjvd9s0lidajytp99nfejifcadfw68oj8s9cdbzm3urk3lgyplum2jyjpop213-runk7s-d1eur4ex03d9xocrontldqcpimsmjqc2v0iyvdd6fnxnyx2eqox.jpg?v=1668486912753"
                              alt=""
                              width={200}
                              height={200}
                            />
                            ...
                            <p className="leading-relaxed">
                              Quantity: <span className="text-red-500">2</span>
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                        <div className="inline-flex items-center gap-x-3">
                          ...
                          <div>
                            <img
                              src="https://goccuanho.com/wp-content/uploads/2023/06/Giay-Adidas-Forum-kem-sua-sieu-cap.jpg"
                              alt=""
                              width={200}
                              height={200}
                            />
